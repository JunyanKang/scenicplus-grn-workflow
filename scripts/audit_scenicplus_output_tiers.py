    ...
    checks: list[dict[str, object]] = [
        {
            ...
            "recommended_outputs": "cell/fragment QC PDF, doublet diagnostics, sample-by-label cell accounting",
        },
        {
        ...
        },
        {
            ...
            "required": [
                ...
                "results/scenicplus_figures/direct/eregulon_auc_heatmap.pdf",
                "results/scenicplus_figures/direct/eregulon_dot_heatmap.pdf",
            ],
        ...
        },
        {
            ...
            "recommended_outputs": "sample-level mean AUC table, condition effect table, diagnostic PDF",
        },
        {
            ...
            "required": [
                "results/scenicplus_figures/direct/tf_target_network.pdf",
                "results/scenicplus_figures/direct/source_tf_target_network_edges.tsv",
            ],
